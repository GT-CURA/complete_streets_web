  ...
  const rows = [
    {
      ...
      attribute: "Width",
      rule: `Wider sidewalk → higher score <span class="rule-note">(> 5 meters: 11.3 for each side)</span>`,
      fullMark: "22.6",
      popup: `
        ...
        <br>
        <ul>
          <li><span class="equation">Score per side = (width / 5 m) × 11.3</span>, capped at 11.3</li>
    ...
    },
    {
      ...
      popup: `
        ...
        <ul>
          ...
          <li>Two sufficiently wide street buffers can earn up to 20.3 in total</li>
        </ul>
        <br>
    ...
    },
    {
      ...
      presence: "Centerline",
      attribute: "Type",
      rule: `Protected <span class="rule-note">(17.2)</span> &gt; Designated <span class="rule-note">(8.6)</span> &gt; None <span class="rule-note">(0)</span>`,
      fullMark: "17.2",
      popup: `
        For each street, we assign a score based on the presence and type of bike lane. A street with a protected bike lane receives the full score of 17.2; a street with a designated lane but without protection receives half the score (8.6); and a street with no bike lane receives 0.
        <br><br>
    ...
    },
    {
      ...
      rule: `Higher accessibility → higher score <span class="rule-note">(> 22 accessibility score: 13.2)</span>`,
      fullMark: "13.2",
      popup: `
        ...
        <br>
        <ul>
          <li><span class="equation">Score = (accessibility score / 22) × 13.2</span>, capped at 13.2</li>
        </ul>
        <br>
    ...
    },
    {
      ...
      presence: "Within a walkshed",
      attribute: "Accessibility score",
      rule: `Higher accessibility → higher score <span class="rule-note">(> 2.5 accessibility score: 10.1)</span>`,
      fullMark: "10.1",
      popup: `
        ...
        <br>
        <ul>
          <li><span class="equation">Score = (accessibility score / 2.5) × 10.1</span>, capped at 10.1</li>
        </ul>
        <br>
    ...
    },
    {
      ...
      presence: "Centerline",
      attribute: "<em>NA</em>",
      rule: `Existing <span class="rule-note">(8.2)</span>; None <span class="rule-note">(0)</span>`,
      fullMark: "8.2",
      popup: `
        Since this element does not have an attribute-based scale, its score is assigned as a simple binary indicator. If a street segment is identified as having a median, it receives the full marks (8.2); otherwise, it receives 0.
      `
    },
    {
      ...
      presence: `Both sides<sup class="footnote-mark">*</sup>`,
      attribute: "<em>NA</em>",
      rule: `Existing <span class="rule-note">(3.8 for each side)</span>; None <span class="rule-note">(0)</span>`,
      fullMark: "7.6",
      popup: `
        Since this element does not have an attribute-based scale, its score is assigned as a simple binary indicator. For each side of the street, if parking is present, that side receives half of the full marks (3.8); otherwise, it receives 0. Scores from both sides are then summed.
      `
    },
    {
      ...
      popup: `
        ...
        <br>
        <ul>
          <li><span class="equation">Score = 0.8 - (0.3 × | number of lanes - reference value |)</span>; if the absolute difference is 3 or more, the score is set to 0</li>
          <li>A street segment earns the full score (0.8) when its number of lanes matches the reference value</li>
        </ul>
        <br>
